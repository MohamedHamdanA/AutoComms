...
//             className={`fixed top-4 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-2xl px-6 py-3 flex items-center justify-between w-[90%] md:w-[60%] z-50 backdrop-blur-lg bg-opacity-80 transition-all duration-300 ${
//                 scrolling ? 'top-2 shadow-xl bg-opacity-90' : ''
//             }`}
//         >
...
//                             <Link className="text-gray-700 hover:text-blue-600 transition">Sign Out</Link>
//                         </motion.div>
//                     )}
//                 </AnimatePresence>
//             </div>
